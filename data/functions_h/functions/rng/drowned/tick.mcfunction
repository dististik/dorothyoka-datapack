...
execute as @e[type=minecraft:drowned,tag=rng_counting,limit=1] run scoreboard players operation #drowned_val rng = #r_value rng
execute as @e[type=minecraft:drowned,tag=rng_counting,limit=1] run scoreboard players operation #drowned_val rng %= #drowned_mod rng
